...
import static io.rhiot.cloudlets.device.verticles.LeshanServerVerticle.CHANNEL_DEVICES_DEREGISTER
import static io.rhiot.cloudlets.device.verticles.LeshanServerVerticle.CHANNEL_DEVICES_DISCONNECTED
import static io.rhiot.cloudlets.device.verticles.LeshanServerVerticle.CHANNEL_DEVICES_LIST
import static io.rhiot.cloudlets.device.verticles.LeshanServerVerticle.CHANNEL_DEVICE_CREATE_VIRTUAL
import static io.rhiot.cloudlets.device.verticles.LeshanServerVerticle.CHANNEL_DEVICE_DEREGISTER
import static io.rhiot.cloudlets.device.verticles.LeshanServerVerticle.CHANNEL_DEVICE_DETAILS
import static io.rhiot.cloudlets.device.verticles.LeshanServerVerticle.CHANNEL_DEVICE_GET
import static io.rhiot.cloudlets.device.verticles.LeshanServerVerticle.CHANNEL_DEVICE_HEARTBEAT_SEND
